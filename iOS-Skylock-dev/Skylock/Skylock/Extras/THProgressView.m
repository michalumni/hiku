...
- (void)drawInContext:(CGContextRef)context
{
    ...
    [self drawRectangleInContext:context inRect:rect withRadius:0];
    ...
    progressRect.size.width = self.progress * progressRect.size.width;//fmaxf(self.progress * progressRect.size.width, 2.0f * progressRadius);
